...
public class OfferLetterService {
    ...
    String htmlContent = buildCustomerOfferLetterEmail(guarantor, calc, defaulterFee, paymentLink, applicationRef);
    ...
    log.info("✅ Customer offer letter sent to: {}", guarantor.getCustomerEmail());
}
...
//    }
    ...
    brevoEmailService.sendEmail(
        ...
        "Guarantor",
        "📋 Loan Agreement - You're Listed as Guarantor",
        htmlContent
    );
    log.info("✅ Guarantor offer letter sent to: {}", guarantor.getGuarantorEmail());
}
