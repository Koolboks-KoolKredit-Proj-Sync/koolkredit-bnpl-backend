...
public class LogisticsEmailService {
    ...
    public LogisticsEmailService(BrevoEmailService brevoEmailService) {
    ...
    public void sendDeliverySchedulingEmail(Map<String, Object> orderData) {
        ...
        brevoEmailService.sendEmail(
            logisticsTeamEmail,
            "Logistics Team",
            "🚚 Delivery Required - Order ID: " + orderData.get("orderId") + " - Stock Confirmed",
            htmlContent
        );
        System.out.println("Logistics delivery email sent for order: " + orderData.get("orderId"));
    }

    // keep buildLogisticsEmailContent, buildButtonUrl, buildSection unchanged
